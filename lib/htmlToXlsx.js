...
module.exports = function (reporter, definition) {
  ...
  if (htmlEngines.chrome) {
    ...
    if (chromeEvalOptions.launchOptions && typeof chromeEvalOptions.launchOptions.args === 'string') {
      chromeEvalOptions.launchOptions.args = chromeEvalOptions.launchOptions.args.split(',')
    }

    const chromeEval = chromePageEval(Object.assign({puppeteer: htmlEngines.chrome}, reporter.options.chrome, options.chrome))
